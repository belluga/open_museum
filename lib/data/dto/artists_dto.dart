...
import 'package:open_museum/data/dto/donation_method_dto.dart';
import 'package:open_museum/data/dto/external_link_dto.dart';
...
class ArtistDTO {
  ...
  ArtistModel toDomain() {
    final _objectIDValue = ObjectIDValue()..parse(id);
