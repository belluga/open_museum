...
import 'package:open_museum/domain/social_network/value_objects/social_network_object_id_value.dart';
...
class SocialNetworkModel {
  final SocialNetworkObjectIDValue objectIDValue;
  ...
  factory SocialNetworkModel.fromDTO(SocialNetworkDTO dto) {
    final _objectIDValue = SocialNetworkObjectIDValue()..doParse(dto.id);
